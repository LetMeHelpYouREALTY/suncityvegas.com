  ...
  return (
    <>
      ...
      <main className="pt-16 md:pt-20">
        <PageHero
          title="Sun Shadows Community Center"
          subtitle="Home to Sun City Summerlin's Olympic-Sized Pool & Spa"
      ...
      <LocalVisitSection heading="See the Olympic pool at Sun Shadows" />
      <Footer />
    </>
  );
}
