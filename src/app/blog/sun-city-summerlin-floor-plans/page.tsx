  ...
  return (
    <>
      ...
      <main className="pt-16 md:pt-20">
        <PageHero
          title="Sun City Summerlin Floor Plans: Complete Guide"
          imageSrc="/images/blog/floor-plans-hero.jpg"
          imageAlt="Sun City Summerlin floor plan examples and home layouts"
          align="left"
        >
        ...
        <RealScoutListings h2Text="Homes for Sale in Sun City Summerlin | Sun City Summerlin Floor Plans" />
      ...
      <LocalVisitSection heading="Walk single-story floor plans in Sun City Summerlin" />
      <Footer />
    </>
  );
}
