  ...
  return (
    <ScrollAnimation delay={delay}>
      <div className="bg-white p-6 md:p-8 rounded-lg shadow-two hover:shadow-three transition-shadow h-full flex flex-col">
        ...
        <p className="text-base md:text-lg text-[#2D2A26] leading-relaxed flex-grow">{text}</p>
      </div>
    </ScrollAnimation>
  );
}
    ...
    <section className="py-16 md:py-20 lg:py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-10 md:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#8B5E3C] mb-3 font-playfair">
